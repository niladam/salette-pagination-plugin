...
use Salette\PaginationPlugin\Tests\Fixtures\Connectors\Async\PagedConnector;
use Salette\PaginationPlugin\Tests\Fixtures\Connectors\Async\OffsetConnector;
use Salette\PaginationPlugin\Tests\Fixtures\Requests\SuperheroLimitOffsetRequest;
use Salette\PaginationPlugin\Tests\Fixtures\Connectors\PagedConnector as SyncPagedConnector;
...
test('you can paginate asynchronously through many pages of results with paged pagination', function () {
    ...
    expect($collection)
        ...
        ->and($collection->sortBy('id')->pluck('id')->toArray())->toEqual(
